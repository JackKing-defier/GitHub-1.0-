...
Page({
    ...
    onShareAppMessage: function () {
        let url = getCurrentPages()[0].__route__;
        const { duoguan_app_is_superhome, duoguan_app_index_path } = _DuoguanData;
        if (duoguan_app_is_superhome) url = duoguan_app_index_path + '?_path=' + encodeURIComponent('/' + this.route);
        return {
